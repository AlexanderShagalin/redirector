#ifndef SERVERPROCESSCOMMAND_H
#define SERVERPROCESSCOMMAND_H
...
class ServerProcessCommand : public ICommand
{
public:
    ServerProcessCommand();

    // static std::string get(std::string request);
